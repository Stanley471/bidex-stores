...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH_ON_DELIVERY', 'CARD', 'BANK_TRANSFER', 'WALLET');

-- CreateEnum
CREATE TYPE "DiscountType" AS ENUM ('PERCENTAGE', 'FIXED');

-- CreateEnum
CREATE TYPE "ShippingType" AS ENUM ('FREE', 'FLAT_RATE', 'NEGOTIABLE');
...
CREATE TABLE "Coupon" (
    ...
    "minimumOrderAmount" DECIMAL(65,30) DEFAULT 0,
...
CREATE TABLE "StoreSettings" (
    "id" TEXT NOT NULL,
    "storeName" TEXT NOT NULL DEFAULT 'CTools Store',
    "storeDescription" TEXT DEFAULT 'Your one-stop shop for quality tools & products',
    "storeTagline" TEXT,
    "logo" TEXT,
    "favicon" TEXT,
    "contactEmail" TEXT,
    ...
    "primaryColor" TEXT NOT NULL DEFAULT '#F68B1E',
    "secondaryColor" TEXT NOT NULL DEFAULT '#FF6600',
    "instagram" TEXT,
    "facebook" TEXT,
    "tiktok" TEXT,
    "twitter" TEXT,
    "youtube" TEXT,
    "isStoreActive" BOOLEAN NOT NULL DEFAULT true,
    "acceptOrders" BOOLEAN NOT NULL DEFAULT true,
    "notificationsEnabled" BOOLEAN NOT NULL DEFAULT true,
    "senderName" TEXT DEFAULT 'CTools Store',
    "senderEmail" TEXT,
    "merchantNotificationEmail" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "order_messages" ADD CONSTRAINT "order_messages_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "order_messages" ADD CONSTRAINT "order_messages_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
