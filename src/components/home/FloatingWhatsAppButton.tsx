...
export function FloatingWhatsAppButton({
  ...
  return (
    ...
    >
      ...
      {/* Official WhatsApp Vector Icon (crisp on all retina screens, zero external dependency) */}
      <svg
        viewBox="0 0 448 512"
        width={34}
        height={34}
        fill="#ffffff"
        className="w-[34px] h-[34px] max-w-[34px] max-h-[34px] max-sm:w-[30px] max-sm:h-[30px] object-contain block transition-transform duration-300 group-hover:scale-105"
        aria-hidden="true"
      >
